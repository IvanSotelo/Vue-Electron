...
module.exports = {
  ...
  filters: {
    ...
    'src/renderer/style/**/*': 'css && cssConfig === \'scss\'',
    'test/e2e/**/*': 'e2e',
    'test/unit/specs/**/*': 'unit',
    'test/unit/jest.conf.js': 'unit && unitConfig === \'jest\'',
    'test/unit/setup.js': 'unit && unitConfig === \'jest\'',
    'test/unit/karma.conf.js': 'unit && unitConfig === \'mocha\'',
    'test/unit/index.js': 'unit && unitConfig === \'mocha\'',
  ...
  complete (data) {
    getCurrentSHA(data.author).then(sha => {
      ...
      console.log([
        ...
        '  \x1b[36m$\x1b[37;1m npm run dev\x1b[0m',
        '',
